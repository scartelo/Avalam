...
public class Tour {
    ...
    */
    public boolean estVoisin(Tour T) {
        return (!T.estInnocupable() && !T.estVide()) && ((T.ligne == ligne || T.ligne + 1 == ligne || T.ligne - 1 == ligne) && (T.colonne == colonne || T.colonne + 1 == colonne || T.colonne - 1 == colonne) && (T.ligne != ligne || T.colonne != colonne));
    }

    public boolean estInnocupable() {
        return contenu == -1;
    }
